...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ers.childhood_obesity'
        db.delete_column(u'data_ers', 'childhood_obesity')


    def backwards(self, orm):
        # Adding field 'Ers.childhood_obesity'
        db.add_column(u'data_ers', 'childhood_obesity',
