...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'data_ers', (
            ...
            ('adult_diabetes', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('adult_obesity', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('childhood_obesity', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('rec_facilities_per_thousand', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('data', ['Ers'])


    def backwards(self, orm):
        # Deleting model 'Ers'
        db.delete_table(u'data_ers')
