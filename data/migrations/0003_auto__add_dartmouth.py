...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'data_dartmouth', (
            ...
            ('DISCHARGE', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=1, blank=True)),
        ))
        db.send_create_signal(u'data', ['Dartmouth'])


    def backwards(self, orm):
        # Deleting model 'Dartmouth'
        db.delete_table(u'data_dartmouth')
    ...
    models = {
        ...
        u'data.dartmouth': {
            'DISCHARGE': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '1', 'blank': 'True'}),
