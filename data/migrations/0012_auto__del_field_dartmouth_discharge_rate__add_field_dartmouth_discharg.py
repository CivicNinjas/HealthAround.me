...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Dartmouth.discharge_rate'
        db.delete_column(u'data_dartmouth', 'discharge_rate')

        # Adding field 'Dartmouth.discharge_rate_per_capita'
        db.add_column(u'data_dartmouth', 'discharge_rate_per_capita',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Ers.adult_obesity'
        db.delete_column(u'data_ers', 'adult_obesity')

        # Deleting field 'Ers.fast_food_rest_per_thousand'
        db.delete_column(u'data_ers', 'fast_food_rest_per_thousand')

        # Deleting field 'Ers.adult_diabetes'
        db.delete_column(u'data_ers', 'adult_diabetes')

        # Deleting field 'Ers.percent_low_access_to_groceries'
        db.delete_column(u'data_ers', 'percent_low_access_to_groceries')

        # Deleting field 'Ers.rec_facilities_per_thousand'
        db.delete_column(u'data_ers', 'rec_facilities_per_thousand')

        # Deleting field 'Ers.farmers_markets_per_thousand'
        db.delete_column(u'data_ers', 'farmers_markets_per_thousand')

        # Deleting field 'Ers.grocery_stores_per_thousand'
        db.delete_column(u'data_ers', 'grocery_stores_per_thousand')

        # Deleting field 'Ers.percent_students_for_free_lunch'
        db.delete_column(u'data_ers', 'percent_students_for_free_lunch')

        # Deleting field 'Ers.percent_students_for_reduced_lunch'
        db.delete_column(u'data_ers', 'percent_students_for_reduced_lunch')

        # Deleting field 'Ers.full_rest_per_thousand'
        db.delete_column(u'data_ers', 'full_rest_per_thousand')

        # Adding field 'Ers.per_adult_diabetes'
        db.add_column(u'data_ers', 'per_adult_diabetes',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.per_adult_obesity'
        db.add_column(u'data_ers', 'per_adult_obesity',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.rec_facilities_per_capita'
        db.add_column(u'data_ers', 'rec_facilities_per_capita',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.fast_food_rest_per_capita'
        db.add_column(u'data_ers', 'fast_food_rest_per_capita',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.full_rest_per_capita'
        db.add_column(u'data_ers', 'full_rest_per_capita',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.farmers_markets_per_capita'
        db.add_column(u'data_ers', 'farmers_markets_per_capita',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.per_low_access_to_groceries'
        db.add_column(u'data_ers', 'per_low_access_to_groceries',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.grocery_stores_per_capita'
        db.add_column(u'data_ers', 'grocery_stores_per_capita',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.per_students_for_free_lunch'
        db.add_column(u'data_ers', 'per_students_for_free_lunch',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.per_students_for_reduced_lunch'
        db.add_column(u'data_ers', 'per_students_for_reduced_lunch',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Dartmouth.discharge_rate'
        db.add_column(u'data_dartmouth', 'discharge_rate',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Dartmouth.discharge_rate_per_capita'
        db.delete_column(u'data_dartmouth', 'discharge_rate_per_capita')

        # Adding field 'Ers.adult_obesity'
        db.add_column(u'data_ers', 'adult_obesity',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.fast_food_rest_per_thousand'
        db.add_column(u'data_ers', 'fast_food_rest_per_thousand',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.adult_diabetes'
        db.add_column(u'data_ers', 'adult_diabetes',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.percent_low_access_to_groceries'
        db.add_column(u'data_ers', 'percent_low_access_to_groceries',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.rec_facilities_per_thousand'
        db.add_column(u'data_ers', 'rec_facilities_per_thousand',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.farmers_markets_per_thousand'
        db.add_column(u'data_ers', 'farmers_markets_per_thousand',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.grocery_stores_per_thousand'
        db.add_column(u'data_ers', 'grocery_stores_per_thousand',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.percent_students_for_free_lunch'
        db.add_column(u'data_ers', 'percent_students_for_free_lunch',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.percent_students_for_reduced_lunch'
        db.add_column(u'data_ers', 'percent_students_for_reduced_lunch',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ers.full_rest_per_thousand'
        db.add_column(u'data_ers', 'full_rest_per_thousand',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Ers.per_adult_diabetes'
        db.delete_column(u'data_ers', 'per_adult_diabetes')

        # Deleting field 'Ers.per_adult_obesity'
        db.delete_column(u'data_ers', 'per_adult_obesity')

        # Deleting field 'Ers.rec_facilities_per_capita'
        db.delete_column(u'data_ers', 'rec_facilities_per_capita')

        # Deleting field 'Ers.fast_food_rest_per_capita'
        db.delete_column(u'data_ers', 'fast_food_rest_per_capita')

        # Deleting field 'Ers.full_rest_per_capita'
        db.delete_column(u'data_ers', 'full_rest_per_capita')

        # Deleting field 'Ers.farmers_markets_per_capita'
        db.delete_column(u'data_ers', 'farmers_markets_per_capita')

        # Deleting field 'Ers.per_low_access_to_groceries'
        db.delete_column(u'data_ers', 'per_low_access_to_groceries')

        # Deleting field 'Ers.grocery_stores_per_capita'
        db.delete_column(u'data_ers', 'grocery_stores_per_capita')

        # Deleting field 'Ers.per_students_for_free_lunch'
        db.delete_column(u'data_ers', 'per_students_for_free_lunch')

        # Deleting field 'Ers.per_students_for_reduced_lunch'
        db.delete_column(u'data_ers', 'per_students_for_reduced_lunch')
    ...
    models = {
        ...
        'data.dartmouth': {
            ...
            'boundary': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['boundaryservice.Boundary']", 'null': 'True', 'blank': 'True'}),
            'discharge_rate_per_capita': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'data.ers': {
            'Meta': {'object_name': 'Ers'},
            'boundary': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['boundaryservice.Boundary']", 'null': 'True', 'blank': 'True'}),
            'farmers_markets_per_capita': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'fast_food_rest_per_capita': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'full_rest_per_capita': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'grocery_stores_per_capita': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'per_adult_diabetes': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'per_adult_obesity': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'per_low_access_to_groceries': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'per_students_for_free_lunch': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'per_students_for_reduced_lunch': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'rec_facilities_per_capita': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'state_abbr': ('django.db.models.fields.CharField', [], {'max_length': '2'})
        }
    }
