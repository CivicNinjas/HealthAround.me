...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ScoreMetric'
        db.create_table(u'healthdata_scoremetric', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.CharField')(default='This is a description', max_length=255)),
            ('data_source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True)),
            ('boundary_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['boundaryservice.BoundarySet'], null=True, blank=True)),
            ('data_property', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('algorithm', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('params', self.gf('jsonfield.fields.JSONField')(default='', null=True, blank=True)),
        ))
        db.send_create_signal(u'healthdata', ['ScoreMetric'])

        # Adding model 'ScoreNode'
        db.create_table(u'healthdata_scorenode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('rel_order', self.gf('django.db.models.fields.IntegerField')(default=100)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['healthdata.ScoreNode'])),
            ('weight', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('metric', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthdata.ScoreMetric'], null=True, blank=True)),
            (u'lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal(u'healthdata', ['ScoreNode'])


    def backwards(self, orm):
        # Deleting model 'ScoreMetric'
        db.delete_table(u'healthdata_scoremetric')

        # Deleting model 'ScoreNode'
        db.delete_table(u'healthdata_scorenode')
    ...
    models = {
        ...
        u'healthdata.scoremetric': {
            ...
            'boundary_set': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['boundaryservice.BoundarySet']", 'null': 'True', 'blank': 'True'}),
            'data_property': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'data_source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']", 'null': 'True', 'blank': 'True'}),
