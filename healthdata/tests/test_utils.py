...
class GetFieldForAreaTest(ForAreaTest):
...
class HighestResDataWithout(ForAreaTest):
    def setUp(self):
        super(HighestResDataWithout, self).setUp()
...
class HighestResDataWith(HighestResDataWithout):
    def setUp(self):
        super(HighestResDataWith, self).setUp()
        Census.objects.create(
